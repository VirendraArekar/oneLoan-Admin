...
import LoanType from "../pages/laonType"
    ...
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/loan-list`}
          render={() => (
            <UserContextProvider>
              <Loan />
            </UserContextProvider>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/loan-banners`}
          render={() => (
            <UserContextProvider>
              <Banner />
            </UserContextProvider>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/offer-banners`}
          render={() => (
            <UserContextProvider>
              <OfferBanner />
            </UserContextProvider>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/loan-types`}
          render={() => (
            <UserContextProvider>
              <LoanType />
            </UserContextProvider>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/residential-types`}
          render={() => (
            <UserContextProvider>
              <Residential />
            </UserContextProvider>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/job-types`}
          render={() => (
            <UserContextProvider>
              <JobType />
            </UserContextProvider>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/user-loans`}
          render={() => (
            <UserContextProvider>
              <UserLoan />
            </UserContextProvider>
