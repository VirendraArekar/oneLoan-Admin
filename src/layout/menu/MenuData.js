const menu = [
  ...
  {
    icon: "card-view",
    text: "Loan Types Manage",
    active: false,
    subMenu: [
      {
        text: "Loan Type Lists",
        link: "/loan-types",
      },
    ],
  },
  ...
  {
    icon: "growth",
    text: "User Loan Manage",
    active: false,
    subMenu: [
      {
        text: "User Loan Lists",
        link: "/user-loans",
      },
    ],
  },
  {
    icon: "img",
    text: "Loan Banner Manage",
    active: false,
    subMenu: [
      {
        text: "Loan Banner Lists",
        link: "/loan-banners",
      },
    ],
  },
  {
    icon: "tranx",
    text: "Offer Banner Manage",
    active: false,
    subMenu: [
      {
        text: "OfferBanner Lists",
        link: "/offer-banners",
      },
    ],
  },
  ...
  {
    icon: "bell",
    text: "Notifications Manage",
    active: false,
    subMenu: [
      {
        text: "Notification Lists",
        link: "/notifications",
      },
    ],
  },
  ...
  {
    icon: "home",
    text: "Address Type Manage",
    active: false,
    subMenu: [
      {
        text: "Residential Types",
        link: "/residential-types",
      },
    ],
  },
  {
    icon: "building",
    text: "Job Type Manage",
    active: false,
    subMenu: [
      {
        text: "Job Types",
