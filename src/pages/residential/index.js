...
const ResidentialType = () => {
  ...
  const onEditSubmit = async(submitData) => {
    ...
    try{
    const res = await fetch(BASE_URL + `residential-type/${editId}`,{
        method : "put",
        headers : {
            "Content-Type" : "application/json",
            'Authorization': 'Bearer ' + accessToken,
  ...
  const onActionClick = async(e) => {
    if (actionText === "delete") {
      ...
      try{
        const res = await fetch(BASE_URL + `residential-type/bulk-delete`,{
            method : "post",
            // mode: 'no-cors',
            headers : {
                "Content-Type" : "application/json",
  ...
  const exportTocsv = () => {
    var csv = '_id,Address Type,Created At\n';
    ...
    hiddenElement.download = 'Address Type.csv';  
    hiddenElement.click();  
  }
  ...
  return (
    <React.Fragment>
      <Head title="Address Type"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle tag="h3" page>
               Residential Address Types
              </BlockTitle>
              <BlockDes className="text-soft">
                <p>You have total {data.length} address types.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add Address Type</h5>
              <div className="mt-4">
                <Form className="row gy-4" onSubmit={handleSubmit(onFormSubmit)}>
                    <Col md="6">
                      ...
                      <input
                        ...
                        ref={register({ required: "Address type is required" })}
                      />
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Address Type</h5>
              <div className="mt-4">
