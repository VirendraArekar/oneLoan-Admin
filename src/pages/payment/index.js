...
const Payment = () => {
  ...
  const bulkActionOptions = [
    { value: "delete", label: "Delete Payment" },
  ];
  ...
  const onEditSubmit = async(submitData) => {
    ...
    try{
    const res = await fetch(BASE_URL + `payment/${editId}`,{
        method : "put",
        headers : {
            "Content-Type" : "application/json",
            'Authorization': 'Bearer ' + accessToken,
  ...
  const onActionClick = async(e) => {
    if (actionText === "delete") {
      ...
      for(var i = 0 ; i < data.length; i++)
      {
        ...
        {
            console.log('In')
            // formData.append(`id[${i}]`, data[i]._id)
            obj[`id[${z}]`] = data[i]._id;
            z++;
        }
      }
  ...
  const exportTocsv = () => {
    var csv = '_id,User Name,Loan Name,Payment By,Payment ID,Amount,Status,Created At\n';
    ...
    hiddenElement.download = 'User Payments.csv';  
    hiddenElement.click();  
  }
      ...
      <Content>
          ...
          <BlockBetween>
            <BlockHeadContent>
              ...
              <BlockDes className="text-soft">
                <p>You have total {data.length} Payments.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Payment</h5>
              <div className="mt-4">
